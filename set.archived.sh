...
curl -X POST -H "Content-Type: application/x-www-form-urlencoded" -d 'result=analysis&query=parent_study%3D%22PRJEB45555%22&fields=sample_accession%2Crun_ref%2Canalysis_date%2Csubmitted_bytes&format=tsv&limit=0' \
